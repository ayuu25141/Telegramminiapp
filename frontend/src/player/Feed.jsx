  ...
  return (
    ...
    >
      <div className="relative aspect-video bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl overflow-hidden shadow-lg shadow-black/50 transition-all duration-300 group-hover:shadow-xl group-hover:shadow-purple-900/30 group-hover:-translate-y-1">
        ...
        <div className="absolute bottom-2 right-2 bg-black/90 backdrop-blur-sm px-2 py-1 rounded-md text-xs font-semibold text-white flex items-center gap-1">
          <Clock className="w-3 h-3" />
          {formatDuration(duration)}
        </div>

        {trending && (
          <div className="absolute top-2 left-2 bg-gradient-to-r from-purple-600 to-pink-600 px-2 py-1 rounded-full text-xs font-bold text-white flex items-center gap-1">
      ...
      <div className="mt-3 px-1">
        <h3 className="text-white font-semibold text-sm md:text-base line-clamp-2 mb-2 leading-snug group-hover:text-purple-300 transition-colors">
          {title}
        </h3>
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-950 to-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="mb-8 sm:mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent mb-3">
            More Video Collection
          </h1>
